...
interface NetworkPath {
    ...
    hopCount: number;
    pathFound: boolean;
    intermediateNodes?: Account[];
    pathTransfers?: TransferVolume[];
}

interface NetworkCluster {
    centerNode: string;
    clusterNodes: string[];
    clusterEdges: TransferVolume[];
    clusterDensity: number;
    averageVolume: bigint;
    dominantDirection: 'incoming' | 'outgoing' | 'bidirectional';
}
...
interface NetworkAnalysis {
    ...
    riskAssessment: {
        ...
        anomalousTransfers: TransferVolume[];
    };
}
